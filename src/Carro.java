...
// -----------------------------------------------------------------
	...
	/**
	 * Calcula el numero de horas que debe pagar el carro seg n el tiempo que lleva
	 * el auto en el parqueadero.
	 * 
	 * @param pHoraSalida Hora a la que el carro sale del parqueadero. pHoraSalida
	 *                    >= horaLlegada.
	 * @return Tiempo que ha estado en parqueadero.
	 */
	public int darTiempoEnParqueadero(int pHoraSalida) {
		int tiempoParqueadero;
		tiempoParqueadero = pHoraSalida - horaLlegada;
